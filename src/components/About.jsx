...
const About = () => {
  return (
    <section id="about" className="relative py-24 px-6 overflow-hidden bg-gray-50 dark:bg-gray-900/60">
      {/* Background Ambient Glow */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-blue-500/5 dark:bg-blue-500/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-purple-500/5 dark:bg-purple-500/10 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2 pointer-events-none" />

      <div className="relative z-10 max-w-6xl mx-auto">
        {/* Section Header */}
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold tracking-wider uppercase bg-blue-500/10 text-blue-600 dark:text-blue-400 border border-blue-500/20 mb-4 shadow-sm">
        ...
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          {/* Left: Bio Narrative */}
          <div className="lg:col-span-5 space-y-6 text-gray-600 dark:text-gray-300">
            <div className="relative p-6 bg-white dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl border border-gray-200/80 dark:border-gray-700/80 shadow-sm overflow-hidden">
              <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-600 to-indigo-600" />
              <h4 className="font-bold text-gray-900 dark:text-white text-base mb-2">MERN Stack Specialist</h4>
            ...
            <div className="relative p-6 bg-white dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl border border-gray-200/80 dark:border-gray-700/80 shadow-sm overflow-hidden">
              ...
              <h4 className="font-bold text-gray-900 dark:text-white text-base mb-2">Product & User-Driven</h4>
              <p className="text-sm leading-relaxed">
            ...
            <div className="p-4 rounded-xl bg-blue-50/70 dark:bg-blue-950/30 border border-blue-200/50 dark:border-blue-900/40 text-xs text-blue-800 dark:text-blue-300 flex items-center gap-3">
          ...
          <div className="lg:col-span-7 grid sm:grid-cols-2 gap-5">
            {capabilities.map((cap) => {
              ...
              return (
                <div
                  key={cap.title}
                  className="group relative p-6 bg-white dark:bg-gray-800/90 rounded-2xl border border-gray-200/80 dark:border-gray-700/80 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden"
                >
                  <div
                  ...
                  />
                  <div className={`w-11 h-11 rounded-xl flex items-center justify-center mb-4 border ${cap.bg}`}>
                    <IconComp className={`w-5 h-5 ${cap.color}`} />
                  </div>
                  <h3 className="text-base font-bold mb-1.5 text-gray-900 dark:text-white tracking-tight">
                    {cap.title}
                  </h3>
