...
const About = () => {
  return (
    <section id="about" className="relative py-16 sm:py-24 px-4 sm:px-6 overflow-hidden bg-gray-50 dark:bg-gray-950">
      {/* Background Ambient Glow */}
      <div className="absolute top-0 right-0 w-72 sm:w-96 h-72 sm:h-96 bg-blue-500/5 dark:bg-blue-500/15 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-72 sm:w-96 h-72 sm:h-96 bg-purple-500/5 dark:bg-purple-500/15 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2 pointer-events-none" />

      <div className="relative z-10 max-w-6xl mx-auto">
        {/* Section Header */}
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 sm:px-4 py-1.5 rounded-full text-xs font-semibold tracking-wider uppercase bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-200 border border-blue-200 dark:border-blue-700/80 mb-3 sm:mb-4 shadow-sm">
          ...
          <p className="mt-3 sm:mt-4 text-gray-600 dark:text-gray-200 text-xs sm:text-sm md:text-base max-w-xl mx-auto px-2 font-medium">
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-5 space-y-4 sm:space-y-6">
            <div className="relative p-5 sm:p-6 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-md overflow-hidden">
              <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-gradient-to-b from-blue-500 to-indigo-500" />
              <h4 className="font-bold text-gray-900 dark:text-white text-base mb-1.5 sm:mb-2">
            ...
            <div className="relative p-5 sm:p-6 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-md overflow-hidden">
              ...
              <p className="text-xs sm:text-sm leading-relaxed text-gray-700 dark:text-gray-200">
                My background in <span className="font-semibold text-purple-700 dark:text-purple-300">Digital Marketing</span> empowers me with a sharp instinct for conversion optimization, user experience, and real-world business requirements.
              </p>
            </div>

            <div className="p-3.5 sm:p-4 rounded-xl bg-blue-50 dark:bg-blue-950/70 border border-blue-200 dark:border-blue-800/80 text-[11px] sm:text-xs text-blue-900 dark:text-blue-200 flex items-center gap-2.5 font-medium shadow-2xs">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
            {capabilities.map((cap) => {
              ...
              return (
                <div
                  key={cap.title}
                  className="group relative p-5 sm:p-6 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden"
                >
                  <div
